...
| 期間 | 会社名 | 役職 | 概要 |
| --- | --- | --- | --- |
| 2024/03 ~ 現在 | [株式会社CHIYUU](https://chiyuu.co.jp/) | 代表兼システムエンジニア | 代表として経営全般を担当しつつ、システムエンジニアとしても従事 |
| 2019/05 ~ 2019/07(3ヶ月) | [MMM Co., Ltd.(現: デロイト トーマツウェブサービス株式会社)](https://mmmcorp.co.jp/) | 正社員 | フリーランスとしてお世話になっていた時に正社員としてお声がけ頂いた |
| 2017/04 ~ 2017/07(4ヶ月) | [DMM ACADEMY(first-generation student)](https://dmm.academy/) | 契約社員 | 第一期生として入学 |
| 2017/01 ~ 2024/02(7年2ヶ月) | CHIYUU(屋号) | 個人事業主 | フリーランスのシステムエンジニアとして従事 |
| 2015/01 ~ 2016/10(1年10ヶ月) | [ACCEL UNIVERSE CORPORATION](https://www.acceluniverse.com/) | 正社員 | システムエンジニアとして従事 |
| 2013/04 ~ 2014/12(1年8ヶ月) | [KINDEN CORPORATION](https://www.kinden.co.jp/) | 正社員 | 電気工事士として従事 |
...
| 領域 | 技術 |
| --- | --- |
| Frontend | HTML5, CSS3, Dart Sass, JavaScript, TypeScript, Vue.js, Nuxt, Angular, ionic, jQuery, Astro, Tailwind CSS, Bootstrap |
| Mobile | Swift, Dart, Flutter |
| Backend | Ruby, Ruby on Rails, PHP, WordPress, Laravel, CakePHP, Node.js, Python, Go |
| Infra | AWS, GCP, Nginx, Puma, Docker, Apache, PostgreSQL, MySQL, DynamoDB, Firebase, Redis, Cloudflare |
| DevOps | GitHub Actions, Ansible, Terraform, AWS CDK, Sentry, New Relic, Datadog, Zabbix |
| Other | tig, tmux, LocalStack, ChatGPT, GitHub Copilot, Claude Code, Cursor, Codex |
